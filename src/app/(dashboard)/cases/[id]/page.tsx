  ...
  return (
    <div className="flex flex-col gap-8 pb-20">
      ...
      >
        ...
        />
        <span className="text-[14px] font-medium">Voltar para casos</span>
      </button>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="p-6 rounded-[24px] bg-(--lc-amber-50)/10 border border-(--lc-amber-100)/50 mt-2">
            <div className="flex items-start gap-3">
              <AlertCircle
                size={20}
                className="text-[var(--lc-amber-600)] mt-0.5"
              />
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[13px] text-(--lc-amber-800)/80 leading-relaxed">
                  Lembre-se de revisar os sinais de alerta das medicações ativas
                  a cada nova sessão.
                </p>
              </div>
            </div>
