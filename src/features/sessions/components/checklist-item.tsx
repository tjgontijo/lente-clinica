  ...
  return (
    <label
      className={cn(
        ...
        checked &&
          isAmber &&
          "bg-[var(--lc-amber-50)] border-[var(--lc-amber-300)]",
    ...
    >
      ...
      <div
        className={cn(
          ...
          checked &&
            isAmber &&
            "bg-[var(--lc-amber-500)] border-[var(--lc-amber-500)]",
          checked &&
            isRed &&
            "bg-[var(--lc-red-600)] border-[var(--lc-red-600)]",
        )}
      >
        {checked && (
      ...
      {checked && (
        <div
          className={cn(
            ...
            isRed &&
              "bg-[var(--lc-red-100)] text-[var(--lc-red-800)] border-[var(--lc-red-200)]",
          )}
        >
