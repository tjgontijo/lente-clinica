    ...
    <nav className="sticky top-0 z-50 w-full border-b border-[var(--lc-neutral-100)] bg-white/80 backdrop-blur-md">
      <div className="container mx-auto flex h-16 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" asChild className="hidden md:flex text-[var(--lc-neutral-600)]">
            <Link href="/sign-in">Entrar</Link>
          </Button>
          <Button asChild className="rounded-full bg-[var(--lc-teal-600)] hover:bg-[var(--lc-teal-700)] text-white px-6">
